...
def display_belanja_kl_chart():
    ...
    <style>
        ...
        .bkl-bar-label { position: absolute; left: 8px; top: 50%; transform: translateY(-50%); color: black; font-size: 0.8em; font-weight: 600; text-shadow: 1px 1px 2px rgba(0,0,0,0.5); }
