...
from utils import tampilkan_header, display_belanja_negara_chart, get_data
from datetime import datetime

# Konfigurasi Halaman
st.set_page_config(
    layout="wide",
    page_title="Realisasi Belanja Negara",
    page_icon="📊"
)
...
with st.sidebar:
    ...
    st.info("Anda sedang melihat laman **realisasi belanja negara**.", icon="📊")
...
st.markdown("<h1 class='main-title'>REALISASI BELANJA NEGARA</h1>", unsafe_allow_html=True)
...
st.caption("""
**Catatan:**
- **Sumber:** SINTESA 28 Februari 2026
