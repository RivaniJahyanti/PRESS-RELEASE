...
# Periode/tanggal
REPORT_YEAR = 2026
st.markdown(f"<p class='period'>Periode: Januari - Mei {REPORT_YEAR}</p>", unsafe_allow_html=True)
...
st.caption("""
**Catatan:**
- **Sumber:** OMSPAN 31 Mei 2026
- Data yang disajikan adalah per tanggal 31 Mei 2026
""")
