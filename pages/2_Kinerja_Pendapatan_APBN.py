...
st.markdown(f"<p class='period'>Periode: Januari - Oktober {current_year}</p>", unsafe_allow_html=True)
...
st.caption("""
**Catatan:**
- **Sumber:** OMSPAN 31 Oktober 2025
- Data yang disajikan adalah per tanggal 31 Oktober 2025
""")
