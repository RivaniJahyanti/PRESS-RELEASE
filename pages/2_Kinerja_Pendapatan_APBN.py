...
# Periode/tanggal
REPORT_YEAR = 2026
st.markdown(f"<p class='period'>Periode: Januari - Juni {REPORT_YEAR}</p>", unsafe_allow_html=True)
...
st.caption("""
**Catatan:**
- **Sumber:** OMSPAN 30 Juni 2026
- Data yang disajikan adalah per tanggal 30 Juni 2026
""")
